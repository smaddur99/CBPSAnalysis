#' Create Publication-Ready Significance Table (Without Balance Column)
#'
#' Creates a formatted table of treatment effects across model specifications,
#' suitable for publication or presentation. This version excludes the covariates balanced column.
#'
